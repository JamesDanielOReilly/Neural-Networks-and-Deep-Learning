...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  fig = nntocf(me,'DESIGN','Table of Contents', ...
    '','by Hagan, Demuth,','Beale, De Jesus');
...
elseif strcmp(cmd,'chap') & (nargin == 2)
  ...
  elseif arg1 == 13
    ...
    res3 = char('nnd13es','nnd13reg','nnd13breg','nnd13esr');
  elseif arg1 == 14
    res1 = 'Dynamic Networks';
    res2 = 'FIR Network|IIR Network|Dynamic Derivatives|Recurrent Network Training';
    res3 = char('nnd14fir','nnd14iir','nnd14dynd','nnd14rnt');
  elseif arg1 == 15
    res1 = 'Associative Learning';
    res2 = 'Unsupervised Hebb|Effects of Decay Rate|Hebb with Decay|Graphical Instar|Instar|Outstar';
    res3 = char('nnd15uh','nnd15edr','nnd15hd','nnd15gis','nnd15is','nnd15os');
  elseif arg1 == 16
    res1 = 'Competitive Networks';
    res2 = ['Competitive Classification|Competitive Learning|1-D Feature Map|',...
            '2-D Feature Map|LVQ1|LVQ2'];
    res3 = char('nnd16cc','nnd16cl','nnd16fm1','nnd16fm2','nnd16lv1','nnd16lv2');
  elseif arg1 == 17

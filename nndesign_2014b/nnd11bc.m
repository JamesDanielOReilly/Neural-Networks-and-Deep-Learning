...
elseif strcmp(cmd,'go') & ~isempty(fig)
  ...
  uistack([fp1_marker fp2_marker fp3_marker],'bottom')
  ...
  uistack([bp1_marker bp2_marker],'bottom')
  ...
  uistack([W1_marker b1_marker W2_marker b2_marker],'bottom')
